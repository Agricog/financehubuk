          ...
          'mainEntity': [
            {
              ...
              'acceptedAnswer': {
                '@type': 'Answer',
                'text': 'A personal loan is unsecured borrowing (typically £1,000–£50,000) from a bank or lender. You receive the money upfront and repay it over a fixed term (1–7 years) with interest.'
              }
            },
            {
              '@type': 'Question',
              ...
              'acceptedAnswer': {
                '@type': 'Answer',
                'text': 'Rates typically range 4.9%–15% depending on your credit score, loan amount, and lender. Excellent credit scores (750+) unlock rates around 4.9%–6.9%.'
              }
            },
            {
              '@type': 'Question',
              'name': 'How is my monthly payment calculated?',
              'acceptedAnswer': {
                '@type': 'Answer',
                'text': 'Monthly payments use an amortization formula based on loan amount, interest rate, and term. This ensures equal payments each month until the loan is cleared.'
              }
            },
            {
              '@type': 'Question',
              ...
              'acceptedAnswer': {
                '@type': 'Answer',
                'text': 'APR (Annual Percentage Rate) includes the interest rate plus all mandatory fees. Always compare APR between lenders, not just the interest rate.'
              }
            }
          ]
        },
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[
                { term: "APR", def: "Annual Percentage Rate—total annual cost of loan including interest plus fees" },
